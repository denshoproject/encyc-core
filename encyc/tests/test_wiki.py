...
def test__articles_a_z():
    ...
    out = wiki._articles_a_z(published_pages, author_pages, non_article_pages)
    assert out == expected
...
def test__category_members():
    ...
    out = wiki._category_members(json.dumps(r_text))
    assert out == expected
...
def test__namespaces():
    ...
    out = wiki._namespaces(json.dumps(r_text))
    assert out == expected
...
def test__published_pages():
    ...
    out = wiki._published_pages(allpages, all_published_pages)
    assert out == expected
...
def test__published_authors():
    ...
    out = wiki._published_authors(publishedpages, categoryauthors)
    assert out == expected
...
def test__whatlinkshere():
    ...
    out =  wiki._whatlinkshere(publishedpages, json.dumps(r_text))
    assert out == expected
